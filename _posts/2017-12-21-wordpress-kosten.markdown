...
Am Ende des Artikels wirst Du ein klares Bild davon haben, welche WordPress Kosten nötig sind und welche nicht.
...
<strong>Auf der anderen Seite:</strong>
...
<img id="infografik-wordpress" src="/img/Infografik-WordPress.com-cs-WordPress.org_-1.jpg" alt="Infografik-WordPress.com-oder-WordPress.org" width="773" height="2201"/>

<img src="/img/geld-verdienen-icon.png" alt="geld-verdienen-icon" width="129" height="129" class="alignnone size-full wp-image-809" />
...
<ul>
	...
	<li><strong>WPEnginge</strong>, eine WordPress-Hosting Gesellschaft, welche über 40 $ Millionen gesammelt hat.</li>
...
Die Anbieter die wir hier empfehlen können, wären <a href="http://bit.ly/2E2vqBW" rel="noopener" target="_blank">Stablehost</a> als Beginner-Hosting Service und <a href="http://bit.ly/2BGspSB" rel="noopener" target="_blank">WPEngine</a> als Premiumhoster.
...
Außerdem können die Features sowie die Funktionen sehr begrenzt sein. Die meisten kostenlosen Themes, kommen zwar mit den üblichen WordPress Features, spezielle Funktionen, wie man sie von den Premium-Themes her kennt, fehlen meistens.
...
Bei den Kosten eines persönlichen WordPress Themes (Custom-Made), gibt es viele verschiedene Dinge die man beachten sollte.
...
<h3>Funktionen, Features und Erweiterungen</h3>
...
<strong>Es ist doch so:</strong>

Wenn man ein Haus bauen möchte, definiert man im Vorfeld genau, wieviele Badezimmer das Haus haben sollte, wie viele Schlafzimmer und wie der Rest aussehen soll. Solch eine ähnliche Liste, muss man auch für seine Website erstellen.

Ein paar Beispiele mit Dingen die sich jemand wünschen kann:

<ul>

	<li>Einen Slider, der automatisch verschiedene Bewertungen für ein Unternehmen aufzeigt.</li>


	<li>Eine Kontakt-Seite mit einem Formular, von dem aus Interessenten mir Nachrichten schicken können.</li>


	<li>Eine Google-Maps Funktion, von der meine Besucher aus den Weg, zu meinem Standort finden können.</li>


	<li>SEO Marketing um z.B. für <a href="https://vnllab.com/optimierung-verschiedene-staedte/" rel="noopener" target="_blank">verschiedene Städte angezeigt zu werden</a>.</li>


	<li>Eine Galerie bei der die Arbeit, das Team oder der Service vorgestellt wird.</li>


	<li>Einen Blog inkl. Social Media Interaktion</li>

</ul>

Eine Liste zu führen, mit all den Dingen die man haben möchte und alles im Vorfeld genau zu planen, hilft dabei die Kosten besser kalkulieren zu können und es hilft enorm bei der Kommunikation zwischen Designer, Entwickler und Kunden.

Ein weiterer Punkt der ziemlich hilfreich ist, man kann sich bereits erstellte Webseiten anschauen und sie als Inspiration benutzen. Man kann z.B. aufschreiben was für Dinge man bei den einzelnen Webseiten mag und was nicht. Damit können dann andere Webdesigner perfekt arbeiten. Das reduziert oft auch die Kosten, da im Vorfeld jedem klar ist, auf was man sich geeinigt hat.

<h3>Plugins</h3>

Als Kunde, sollte man genau prüfen ob es bereits Plugins gibt, die einem bei den gewünschten Funktionen der Website helfen könnten. Professionelle Entwickler arbeiten meistens auch mit Plugins, da es einfach kein Sinn macht, Dinge die bereits gut funktionieren von 0 auf aufzubauen. Wenn man also als Kunde eine genau Übersicht der Plugins hat, kann man sich mit dem WordPress-Entwickler im Vorfeld darauf einigen, die richtigen Plugins zu benutzen.

<img src="/img/plugins-beispiele-wordpress-maske.png" alt="wordpress-plugins-maske" width="1517" height="791" class="alignnone size-full wp-image-897" />
